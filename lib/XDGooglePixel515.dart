...
class XDGooglePixel515 extends StatelessWidget {
  XDGooglePixel515({
    Key? key,
  }) : super(key: key);
  @override
        ...
        children: <Widget>[
          Pinned.fromPins(
            ...
            child: Stack(
              children: <Widget>[
                Pinned.fromPins(
                  Pin(start: -813.0, end: -1549.0),
                  Pin(start: -1023.0, end: -211.0),
                  child:
          ...
          Pinned.fromPins(
            Pin(start: 14.2, end: 3.8),
            Pin(size: 165.6, start: 0.0),
          ...
          Pinned.fromPins(
            Pin(start: 23.2, end: 12.8),
            Pin(size: 85.0, start: 9.0),
            child:
          ...
          Pinned.fromPins(
            Pin(size: 133.6, middle: 0.5458),
            Pin(size: 273.3, middle: 0.4068),
            child:
                // Adobe XD layer: 'route' (group)
                Stack(
              children: <Widget>[
                Pinned.fromPins(
                  Pin(size: 101.8, end: 0.0),
                  Pin(start: 0.0, end: 28.2),
                  child: SvgPicture.string(
                    _svg_ypzmta,
                    allowDrawingOutsideViewBox: true,
                    fit: BoxFit.fill,
          ...
          Pinned.fromPins(
            Pin(start: -352.7, end: -364.0),
            Pin(size: 1120.0, end: -971.0),
            child:
              ...
              child: Stack(
                children: <Widget>[
                  ...
                  Pinned.fromPins(
                    Pin(size: 178.0, middle: 0.5095),
                    Pin(size: 22.0, start: 76.0),
                    child: Text(
                      '3 km uzakta - 10 dakika',
                      style: TextStyle(
                        fontFamily: 'Poppins',
                        fontSize: 17,
                        color: const Color(0xffff9900),
...
const String _svg_diyp3c =
    '<svg viewBox="14.2 0.0 375.0 165.6" ><defs><linearGradient id="gradient" x1="0.5" y1="0.0" x2="0.5" y2="1.140165"><stop offset="0.0" stop-color="#ffffffff"  /><stop offset="0.605911" stop-color="#a3ffffff" stop-opacity="0.64" /><stop offset="1.0" stop-color="#00ffffff" stop-opacity="0.0" /></linearGradient></defs><path transform="translate(14.16, 0.0)" d="M 0 0 L 375 0 L 375 165.5509643554688 L 0 165.5509643554688 L 0 0 Z" fill="url(#gradient)" stroke="none" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
const String _svg_ypzmta =
    '<svg viewBox="31.9 0.0 101.8 245.1" ><path transform="translate(-2329.16, -299.0)" d="M 2361.038330078125 544.1240234375 L 2459.18994140625 364.7274780273438 C 2459.18994140625 364.7274780273438 2470.859375 352.8035583496094 2452.275634765625 340.6022338867188 C 2433.69189453125 328.4009704589844 2375.75244140625 299.002197265625 2375.75244140625 299.002197265625" fill="none" stroke="#ff9a00" stroke-width="5" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
const String _svg_ownp5j =
    '<svg viewBox="0.0 220.3 53.2 53.0" ><defs><filter id="shadow"><feDropShadow dx="0" dy="3" stdDeviation="6"/></filter></defs><path transform="matrix(0.829038, 0.559193, -0.559193, 0.829038, 21.27, 220.28)" d="M 34.40388107299805 37.79141616821289 L 19.22724914550781 31.49738311767578 L 4.050613880157471 37.79141616821289 C 1.723522543907166 38.75614166259766 -0.7691245079040527 36.77223205566406 0.2242682874202728 34.74942779541016 L 16.64262008666992 1.458752393722534 C 17.59920120239258 -0.4862508773803711 20.85527801513672 -0.4862508773803711 21.82106399536133 1.458752393722534 L 38.23022079467773 34.74942779541016 C 39.22360992431641 36.76445007324219 36.73095703125 38.75614166259766 34.40388107299805 37.79141616821289 Z" fill="#2b2b2b" stroke="#ffffff" stroke-width="3" stroke-miterlimit="4" stroke-linecap="butt" filter="url(#shadow)"/></svg>';
const String _svg_2jmwt2 =
    '<svg viewBox="0.0 0.0 1109.7 1120.0" ><path  d="M 554.8502197265625 0 C 861.2854614257812 0 1109.700439453125 250.7205505371094 1109.700439453125 560 C 1109.700439453125 869.2794189453125 861.2854614257812 1120 554.8502197265625 1120 C 248.4149169921875 1120 0 869.2794189453125 0 560 C 0 250.7205505371094 248.4149169921875 0 554.8502197265625 0 Z" fill="#ffffff" stroke="none" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
