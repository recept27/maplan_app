        ...
        children: <Widget>[
          Pinned.fromPins(
            ...
            child: Stack(
              children: <Widget>[
                Pinned.fromPins(
                  Pin(start: -702.0, end: -937.0),
                  Pin(start: -659.0, end: -1.0),
                  child:
          ...
          Pinned.fromPins(
            Pin(start: -869.0, end: 44.0),
            Pin(size: 169.0, end: 52.0),
            child:
          ...
          Pinned.fromPins(
            Pin(size: 134.0, middle: 0.5328),
            Pin(size: 3.0, middle: 0.9894),
            child:
          ...
          Pinned.fromPins(
            Pin(size: 37.9, start: 21.8),
            Pin(size: 37.8, middle: 0.5901),
            child:
          ...
          Pinned.fromPins(
            Pin(start: 48.0, end: 9.0),
            Pin(size: 403.0, start: 119.0),
            child:
...
const String _svg_dk6clx =
    '<svg viewBox="18.0 0.0 375.0 165.6" ><defs><linearGradient id="gradient" x1="0.5" y1="0.0" x2="0.5" y2="1.140165"><stop offset="0.0" stop-color="#ffffffff"  /><stop offset="0.605911" stop-color="#a3ffffff" stop-opacity="0.64" /><stop offset="1.0" stop-color="#00ffffff" stop-opacity="0.0" /></linearGradient></defs><path transform="translate(18.0, 0.0)" d="M 0 0 L 375 0 L 375 165.5509643554688 L 0 165.5509643554688 L 0 0 Z" fill="url(#gradient)" stroke="none" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
...
const String _svg_9qizkw =
    '<svg viewBox="0.0 0.0 37.9 37.8" ><defs><filter id="shadow"><feDropShadow dx="0" dy="3" stdDeviation="6"/></filter></defs><path transform="matrix(0.829038, 0.559193, -0.559193, 0.829038, 15.15, 0.0)" d="M 24.50200271606445 26.91456604003906 L 13.69340133666992 22.43203544616699 L 2.884796142578125 26.91456604003906 C 1.227470397949219 27.60162925720215 -0.547760009765625 26.18871688842773 0.1597213745117188 24.74810218811035 L 11.8526611328125 1.038905024528503 C 12.53392791748047 -0.3463016152381897 14.85286331176758 -0.3463016152381897 15.54068374633789 1.038905024528503 L 27.22707366943359 24.74810218811035 C 27.93455505371094 26.18317413330078 26.15931701660156 27.60162925720215 24.50200271606445 26.91456604003906 Z" fill="#2b2b2b" stroke="#ffffff" stroke-width="3" stroke-miterlimit="4" stroke-linecap="butt" filter="url(#shadow)"/></svg>';
